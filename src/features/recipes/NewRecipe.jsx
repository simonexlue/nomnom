...
export default function NewRecipe() {
    ...
    const pillClass =
        "group relative inline-flex items-center rounded-full bg-yellow-100 px-3 py-1 text-xs font-medium text-gray-900 mt-1 cursor-pointer select-none hover:bg-yellow-200";
